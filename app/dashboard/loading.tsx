  ...
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="space-y-2">
        ...
        <div className="h-4 w-80 rounded-md bg-slate-200/70" />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="h-28 rounded-2xl border border-slate-200/80 bg-white p-4 space-y-3"
          >
      ...
      <div className="grid gap-4 lg:grid-cols-3 lg:gap-5">
        <div className="space-y-4 lg:col-span-2">
          <div className="h-64 rounded-2xl border border-slate-200/80 bg-white p-5 space-y-4">
            <div className="h-4 w-32 rounded-md bg-slate-200" />
            <div className="h-12 w-full rounded-xl bg-slate-100" />
            <div className="h-12 w-full rounded-xl bg-slate-100" />
          </div>
          <div className="h-56 rounded-2xl border border-slate-200/80 bg-white p-5 space-y-3">
        ...
        <div className="space-y-4">
          <div className="h-44 rounded-2xl border border-slate-200/80 bg-white p-5 space-y-3">
            <div className="h-4 w-28 rounded-md bg-slate-200" />
            <div className="h-14 w-full rounded-xl bg-slate-100" />
          </div>
          <div className="h-56 rounded-2xl bg-slate-900 p-5 space-y-3">
            <div className="h-4 w-32 rounded-md bg-slate-800" />
            <div className="h-16 w-full rounded-xl bg-slate-800/80" />
          </div>
        </div>
      </div>
    </div>
