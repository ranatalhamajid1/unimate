...
export function DeleteExpenseDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Dialog */}
      <div className="relative w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-6 shadow-xl transition-all">
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col items-center text-center">
          <div className="mb-3.5 flex h-12 w-12 items-center justify-center rounded-2xl bg-rose-50 text-rose-600">
          ...
          <div className="mt-4 w-full rounded-xl border border-slate-100 bg-slate-50 p-3 text-left">
          ...
          <div className="mt-6 flex w-full items-center gap-2">
            <button
              ...
              onClick={onClose}
              disabled={isDeleting}
              className="w-1/2 rounded-xl border border-slate-200 py-2.5 text-[13px] font-medium text-slate-700 hover:bg-slate-50 transition"
            >
              Cancel
            </button>
            <button
