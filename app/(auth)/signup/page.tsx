          ...
          <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-7 shadow-[var(--shadow-lg)] sm:p-8">
            ...
            <div className="mb-6 flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={benefit}
                  className="flex items-center gap-1.5 rounded-full border border-blue-100 dark:border-blue-500/20 bg-blue-50 dark:bg-blue-500/10 px-2.5 py-1 text-[11px] font-medium text-blue-700 dark:text-blue-400"
                >
            ...
            <form action={action} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <User className="pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-[var(--color-text-3)]" />
                  <input
                    id="signup-name"
                    name="name"
                    type="text"
              ...
              <div>
                ...
                {!state?.errors?.password && (
                  <p className="mt-1.5 text-[11.5px] text-[var(--color-text-3)]">
            ...
            {/* Login link */}
            <p className="mt-5 text-center text-[13px] text-[var(--color-text-2)]">
              Already have an account?{" "}
              <Link
                href="/login"
                className="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors"
