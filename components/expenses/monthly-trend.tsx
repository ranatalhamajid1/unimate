    ...
    return (
      <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5 shadow-[0_1px_3px_rgba(15,23,42,0.04)]">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-[14px] font-semibold text-[var(--color-text)]">Monthly Spending Trend</h3>
        </div>
        <div className="py-8 text-center">
          <p className="text-[13px] text-[var(--color-text-2)] font-medium">No spending trend yet.</p>
  ...
  return (
    <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5 shadow-[0_1px_3px_rgba(15,23,42,0.04)]">
      <div className="flex items-center justify-between mb-5">
        ...
        <span className="text-[12px] font-medium text-[var(--color-text-3)]">Last 6 Months</span>
      </div>
      ...
      <div className="flex items-end justify-between gap-2 h-36 pt-4 px-2">
        {trend.map((item) => {
          ...
          return (
            ...
            >
              {/* Tooltip on hover */}
              <div className="opacity-0 group-hover:opacity-100 transition-opacity text-[10.5px] font-bold text-[var(--color-text)] bg-[var(--color-surface-2)] border border-[var(--color-border)] px-1.5 py-0.5 rounded shadow-sm whitespace-nowrap mb-1">
                {item.amountString}
              </div>

              {/* Bar */}
              <div className="w-full max-w-[38px] bg-[var(--color-surface-2)] rounded-t-lg overflow-hidden flex items-end h-full">
                <div
