        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3.5 py-2.5 text-[14px] text-slate-800 outline-none transition focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/10"
            >
              {courses.map((c) => (
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3.5 py-2 text-[14px] text-slate-800 outline-none transition focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/10"
              />
            </div>
              ...
              <input
                ...
                className={`w-full rounded-xl border px-3.5 py-2 text-[14px] outline-none transition ${
                  isExceeded
                    ...
                    : "border-slate-200 bg-slate-50/50 text-slate-800 focus:border-emerald-500 focus:bg-white focus:ring-2 focus:ring-emerald-500/10"
                }`}
              />
            </div>
          </div>
          ...
          <div className="rounded-xl border border-slate-200/80 bg-slate-50/70 p-4">
            <div className="flex items-center justify-between mb-2">
              <div>
                <p className="text-[12px] font-medium text-slate-500">Calculated Attendance</p>
