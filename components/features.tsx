    ...
    <section id="features" className="scroll-mt-24 px-4 py-20 sm:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-14 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {/* ─ Courses — 2-col wide ─ */}
          <div className="group relative col-span-1 overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-6 transition-all duration-300 hover:border-slate-300 hover:shadow-[0_16px_40px_-16px_rgba(15,23,42,0.10)] sm:col-span-2 lg:col-span-2">
            <div className="flex items-start justify-between">
              <div>
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-900 text-white transition-colors duration-300 group-hover:bg-blue-600">
                  <BookOpen className="h-5 w-5" strokeWidth={1.75} />
                </span>
                <h3 className="mt-4 text-[17px] font-semibold text-slate-900">
                  Courses
                </h3>
                <p className="mt-1.5 max-w-xs text-[14px] leading-relaxed text-slate-500">
                  Keep notes, assignments, labs and resources organized by
                  course. Everything in one place, always findable.
                </p>
              </div>
              <ChevronRight className="mt-1 h-4 w-4 shrink-0 text-slate-300 transition-colors group-hover:text-blue-500" />
            </div>
            ...
            <div className="mt-5 space-y-2">
              {[
                ...
                <div
                  key={c.code}
                  className="flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50/70 px-4 py-2.5"
                >
          ...
          {/* ─ Smart Timetable ─ */}
          <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-6 transition-all duration-300 hover:border-slate-300 hover:shadow-[0_16px_40px_-16px_rgba(15,23,42,0.10)]">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-900 text-white transition-colors duration-300 group-hover:bg-blue-600">
            ...
            <div className="mt-4 space-y-2">
              {[
                ...
                >
                  ...
                  <span className="flex-1 rounded-lg bg-blue-50 px-3 py-1.5 font-medium text-blue-700">
                    {s.label}
                  </span>
                </div>
              ))}
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-6 transition-all duration-300 hover:border-slate-300 hover:shadow-[0_16px_40px_-16px_rgba(15,23,42,0.10)]">
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2.5">
                ...
                <span className="text-[11px] text-slate-400">Fri</span>
              </div>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-6 transition-all duration-300 hover:border-slate-300 hover:shadow-[0_16px_40px_-16px_rgba(15,23,42,0.10)]">
            ...
            <div className="mt-4 flex items-end gap-3">
              <div>
                ...
                <p className="mt-0.5 text-[2.25rem] font-semibold leading-none tracking-tight text-slate-900">
                  3.50
                </p>
              </div>
