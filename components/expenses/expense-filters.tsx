      ...
      <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-white pl-9 pr-8 py-2 text-[13px] text-slate-800 placeholder-slate-400 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10"
          />
          {search && (
            <button
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="flex-shrink-0 text-[12px] font-medium text-blue-600 hover:text-blue-700 hover:underline"
          >
            Clear Filters
          </button>
        )}
